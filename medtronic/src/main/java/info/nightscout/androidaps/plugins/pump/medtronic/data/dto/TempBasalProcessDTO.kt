...
class TempBasalProcessDTO constructor(
        ...
        get() {
            ...
            if (objectType == ObjectType.TemporaryBasal) {
                if (itemTwo == null) {
                    ...
                    aapsLogger.debug(
                        LTag.PUMP,
                        "Found 2 items for duration: itemOne=$itemOne, itemTwo=$itemTwo"
                    )
                    val secondsDiff = DateTimeUtil.getATechDateDiferenceAsSeconds(
                        itemOne.atechDateTime,
                        itemTwo!!.atechDateTime
                    )
                ...
                aapsLogger.debug(
                    LTag.PUMP,
                    "Found 2 items for duration (in SuspendMode): itemOne=$itemOne, itemTwo=$itemTwo"
                )
                val secondsDiff = DateTimeUtil.getATechDateDiferenceAsSeconds(
                    itemOne.atechDateTime,
                    itemTwo!!.atechDateTime
